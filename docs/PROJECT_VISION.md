...
Exivは、**AIコンテナ**と**プラグインセット**の組み合わせにより、
...
| **セキュリティ** | 広範なローカル権限（批判あり） | サンドボックス・パーミッション分離 |
| **拡張** | TypeScript / WASM / Skills | Rust プラグイン + Python Bridge |
| **ライセンス** | Apache 2.0 | BSL 1.1 → MIT (2028) |

### OpenClawの構造的弱点

1. **セキュリティが構造的弱点** — サイバーセキュリティ研究者から批判されている
2. **チャットUIのみ** — ビジュアルリッチな体験ができない
3. **「AIパートナー」ではなく「AIアシスタント」** — 感情的繋がりの設計がない
4. **創設者がOpenAIへ移籍** (2026-02-15) — コミュニティの不安定期
...
**メッセージ:**
> *「OpenClawのセキュリティが心配？Exivはパーミッション分離とサンドボックスで設計されています。」*
...
Exivは「GUIで構築するAIパートナー」である。**

OpenClawはメッセージングプラットフォーム上のテキストインターフェースに縛られている。
Exivは、ビジュアル・音声・人格を持つAIを、
