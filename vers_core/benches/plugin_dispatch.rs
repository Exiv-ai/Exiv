...
// Critical path: vers_core/src/managers.rs:80-162 (PluginRegistry::dispatch_event)
// Measures: FuturesUnordered concurrency, semaphore contention, plugin execution

use criterion::{criterion_group, criterion_main, Criterion, BenchmarkId};
use std::sync::Arc;
use tokio::sync::mpsc;
use vers_shared::{Plugin, VersEvent, VersEventData, PluginManifest, PluginCategory, ServiceType, PluginCast};
use std::any::Any;
