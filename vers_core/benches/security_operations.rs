...
// Critical paths:
// - vers_core/src/capabilities.rs:54-56 (SafeHttpClient whitelist check via send_http_request)
// - vers_core/src/handlers.rs:27 (constant-time comparison)
...
fn constant_time_comparison_benchmark(c: &mut Criterion) {
    ...
    c.bench_function("security_constant_time_compare", |b| {
        b.iter(|| {
            ...
            // From vers_core/src/handlers.rs:27
