...
// Critical paths:
// - vers_core/src/db.rs:21-30 (SqliteDataStore::set_json)
// - vers_core/src/db.rs:32-45 (SqliteDataStore::get_json)
// - vers_core/src/managers.rs:274-291 (PluginManager::fetch_plugin_configs)
        ...
        group.bench_with_input(
            ...
            |b, data| {
                b.to_async(&runtime).iter(|| async {
                    ...
                    // From vers_core/src/db.rs:21-30
...
fn get_json_benchmark(c: &mut Criterion) {
    ...
    c.bench_function("db_get_json", |b| {
        b.to_async(&runtime).iter(|| async {
            ...
            // From vers_core/src/db.rs:32-45
...
fn get_all_json_benchmark(c: &mut Criterion) {
    ...
    c.bench_function("db_get_all_json", |b| {
        b.to_async(&runtime).iter(|| async {
            ...
            // From vers_core/src/db.rs:47-62
