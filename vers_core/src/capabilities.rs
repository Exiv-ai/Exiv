...
mod tests {
    ...
    fn test_is_whitelisted_host_case_insensitive() {
        let client = SafeHttpClient::new(vec!["ExAmPlE.CoM".to_string()]);
    ...
    fn test_is_whitelisted_host_not_in_list() {
        let client = SafeHttpClient::new(vec!["allowed.com".to_string()]);
    ...
    fn test_hashset_o1_lookup() {
        ...
        let client = SafeHttpClient::new(large_whitelist);
